...
if (run.status === 0) {
  console.error('CI_CHECK_FAIL negative schema gate test unexpectedly passed');
...
console.log('CI_CHECK_OK release verdict schema gate fails closed on invalid enum input');
