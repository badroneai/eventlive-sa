...
assert.equal(sourceRunLimits({ trust_level: 'official', intake_policy: 'official-feed-preferred' }).ended, 200, 'trusted official sources must receive the high-yield ended default');
...
assert.match(collector, /sourceRunLimits\(source\)/, 'collector must apply the shared source limit policy');
