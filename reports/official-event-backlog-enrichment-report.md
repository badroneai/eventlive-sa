...
- Generated at: 2026-09-20T08:00:17.126Z
- Targets: 100
- Enriched: 100
- Fetched: 25
- Images: 93
...
|---|---|---:|---:|---:|
| Umm Al-Qura University Events Center | الارشاد الأكاديمي ومهارات دعم الطلبة | official-page-meta | yes | yes |
| Umm Al-Qura University Events Center | دورة تدريبية بعنوان إدارة الجودة 9001 | official-page-meta | yes | yes |
| Discover Aseer Events | "Blackberry Farm " | approved-source-row | yes | HTTP 404 |
...
| Discover Aseer Events | Cowboy Town | approved-source-row | yes | HTTP 404 |
...
| Hayy Jameel What's On | Hayy Explorers | As Told by the Land: Constructed Worlds | official-page-meta | yes | yes |
| Hayy Jameel What's On | Hayy Sounds | Listening Session: Rotations of Bismillah with Atiyyah Khan and Huda Tayob | official-page-meta | yes | yes |
| Hayy Jameel What's On | Hayy Sounds | Listening Stations, Part of the Exhibition ‘Red Wind, Coral Worlds’ | official-page-meta | yes | yes |
...
| Discover Aseer Events | Mabdaa Festival | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | MARNIS | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Mdmak | approved-source-row | yes | HTTP 404 |
...
| Discover Aseer Events | Muftaha District | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Musical concerts | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Nafas | approved-source-row | yes | HTTP 404 |
...
| Discover Aseer Events | PLATO | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Qusoor Abu Sarah | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Qusoor Al Asabila | approved-source-row | yes | HTTP 404 |
| Hayy Jameel What's On | Hayy Explorers | Recess Showcase: Time Reflected on Water | official-page-meta | yes | yes |
| Discover Aseer Events | Rekaib Farm | approved-source-row | yes | HTTP 404 |
| Discover Aseer Events | Rural Village- Art Street | approved-source-row | yes | HTTP 404 |
...
| Discover Aseer Events | Sky Village | approved-source-row | yes | HTTP 404 |
...
| Discover Aseer Events | Summer Legacy | approved-source-row | yes | HTTP 404 |
...
| Visit Saudi Summer Calendar PDF | أمازونيا فان زون | approved-source-row | no | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | ارياش | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | باتو | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | تيفو فان زون | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | حديقة مطار ابها الدولي | approved-source-row | yes | The operation was aborted due to timeout |
| Asharqia Chamber Events | حفل الاستقبال السنوي لقطاع الاعمال 2026م | official-page-meta | no | yes |
| Umm Al-Qura University Events Center | دبلوم إدارة المشاريع | official-page-meta | yes | yes |
...
| Visit Saudi Summer Calendar PDF | صيف وِرث 2026 | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | صيف وسمرة | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | عرض ستاند أب كوميدي مع شاكر الشريف | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | ”فينا نحكي؟“ كوميديا ستاند أب مع جون أشقر | official-page-meta | yes | yes |
| Visit Saudi Summer Calendar PDF | كايف المزرعة | approved-source-row | yes | The operation was aborted due to timeout |
| Monsha'at All Events | لقاءات شهر سبتمبر 2026م | approved-source-row | no | fetch failed |
| Monsha'at All Events | لقاءات شهر سبتمبر (المغلقة) 2026م | approved-source-row | no | fetch failed |
| Visit Saudi Summer Calendar PDF | ليالي المباريات في أكت 1 | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | ليالي المباريات في ذا هب | official-page-meta | no | yes |
| Visit Saudi Summer Calendar PDF | ليالي المونديال | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | ليلة ستاند أب كوميدي | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | مارنيز | approved-source-row | yes | The operation was aborted due to timeout |
| Visit Saudi Summer Calendar PDF | مدماك | approved-source-row | yes | The operation was aborted due to timeout |
| Asharqia Chamber Events | ملتقى الذكاء الاصطناعي في سوق العمل والتنمية الاجتماعية 2026 | official-page-meta | no | yes |
