...
Generated at: 2026-09-17T08:17:27.476Z
...
| 2 | visit-saudi-calendar | active-collector | productive | 46 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 19 | visit-saudi-seasons | active-collector | productive | 19 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 5 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 39 | discover-aseer-events | active-collector | zero-yield | 0 | yes | Zero-yield for 11 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 44 | saudi-water-authority-events | active-collector | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 81 | jouf-university-programs | venue-dedupe | zero-yield | 0 | no | Zero-yield for 5 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
