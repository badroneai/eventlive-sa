...
Generated at: 2026-09-25T23:33:33.213Z
...
| 23 | ithra-events | active-collector | productive | 90 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | probe-blocked | 37 | no | Do not bypass protection; keep as blocked/partnership candidate: timeout |
...
| 44 | saudi-water-authority-events | active-collector | zero-yield | 0 | no | Zero-yield for 8 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 54 | sdaia-calendar-events | active-collector | zero-yield | 0 | no | Zero-yield for 6 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 76 | umm-al-qura-events | active-collector | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 81 | jouf-university-programs | venue-dedupe | zero-yield | 0 | no | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
