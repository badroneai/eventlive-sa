...
Generated at: 2026-07-10T09:13:20.012Z
...
| code-mcit-programs | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| ithra-events | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 16 | raw_harvest_to_candidate_queue | Zero-yield for 16 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| northern-borders-chamber-events | zero-yield | 9 | probe_before_collector | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| tabuk-chamber-events | zero-yield | 9 | probe_before_collector | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | zero-yield | 0 | yes | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 16 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
