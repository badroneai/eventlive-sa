...
Generated at: 2026-09-15T16:23:39.882Z
...
- Sources: 88
- Attempted this run: 48
- Deferred by adaptive cadence: 0
- Productive: 22
- Zero-yield: 16
- Collector errors: 7
...
| code-mcit-programs | zero-yield | 78 | raw_harvest_to_candidate_queue | Zero-yield for 78 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 78 | raw_harvest_to_candidate_queue | Zero-yield for 78 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 72 | raw_harvest_to_candidate_queue | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 2 | visit-saudi-calendar | active-collector | productive | 42 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 78 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | productive | 102 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 78 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | productive | 26 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 39 | discover-aseer-events | active-collector | zero-yield | 0 | yes | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 44 | saudi-water-authority-events | active-collector | zero-yield | 0 | no | date/content signals exist but extractor returned no complete future rows |
...
| 48 | sfda-events | active-collector | zero-yield | 0 | no | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 54 | sdaia-calendar-events | active-collector | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 56 | scega-exhibitions-conferences | active-collector | productive | 2 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 19 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 39 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 21 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 71 | najran-municipality-summer-events | venue-dedupe | zero-yield | 0 | no | Zero-yield for 19 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 81 | jouf-university-programs | venue-dedupe | zero-yield | 0 | no | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 27 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 85 | hayy-jameel-events | active-collector | productive | 23 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 87 | kau-events | venue-dedupe | zero-yield | 0 | no | Zero-yield for 13 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 88 | saudicon-events | discovery-only | productive | 2 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
