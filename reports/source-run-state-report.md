...
Generated at: 2026-09-24T08:11:48.321Z
...
| scega-exhibitions-conferences | collector-error | 0 | raw_harvest_to_candidate_queue | Fix collector error: fetch failed |
...
| 23 | ithra-events | active-collector | productive | 92 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 44 | saudi-water-authority-events | active-collector | zero-yield | 0 | no | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 54 | sdaia-calendar-events | active-collector | zero-yield | 0 | no | Zero-yield for 5 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 56 | scega-exhibitions-conferences | active-collector | collector-error | 0 | no | Fix collector error: fetch failed |
...
| 81 | jouf-university-programs | venue-dedupe | zero-yield | 0 | no | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 85 | hayy-jameel-events | active-collector | productive | 12 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
