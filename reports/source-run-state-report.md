...
Generated at: 2026-07-19T08:40:20.715Z
...
| code-mcit-programs | zero-yield | 72 | raw_harvest_to_candidate_queue | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 72 | raw_harvest_to_candidate_queue | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 72 | raw_harvest_to_candidate_queue | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 72 | raw_harvest_to_candidate_queue | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 2 | visit-saudi-calendar | active-collector | productive | 31 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 17 | future-skills-catalog | active-collector | productive | 3 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 19 | visit-saudi-seasons | active-collector | productive | 13 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | productive | 127 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 72 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 35 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | productive | 88 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 66 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 66 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 28 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 8 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 71 | najran-municipality-summer-events | venue-dedupe | zero-yield | 0 | no | date/content signals exist but extractor returned no complete future rows |
...
| 80 | qassim-university-events | venue-dedupe | zero-yield | 0 | no | past-date:1 |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 16 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 85 | hayy-jameel-events | active-collector | productive | 8 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
