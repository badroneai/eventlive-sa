...
Generated at: 2026-07-10T10:10:20.512Z
...
| ricec-events | probe-blocked | 0 | dedupe_anchor_only | Do not bypass protection; keep as blocked/partnership candidate: fetch failed Connect Timeout Error (attempted address: www.ricec.com:443, timeout: 10000ms) TypeError: fetch failed |
...
| middle-east-banking-ai-summit | probe-blocked | 0 | probe_before_collector | Do not bypass protection; keep as blocked/partnership candidate: bot-protection |
| code-mcit-programs | zero-yield | 57 | raw_harvest_to_candidate_queue | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 57 | raw_harvest_to_candidate_queue | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 57 | raw_harvest_to_candidate_queue | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 57 | raw_harvest_to_candidate_queue | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 51 | raw_harvest_to_candidate_queue | Zero-yield for 51 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 51 | raw_harvest_to_candidate_queue | Zero-yield for 51 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 19 | raw_harvest_to_candidate_queue | Zero-yield for 19 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| northern-borders-chamber-events | zero-yield | 12 | probe_before_collector | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| tabuk-chamber-events | zero-yield | 12 | probe_before_collector | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 3 | moc-cultural-calendar | active-collector | productive | 13 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 4 | mos-events | active-collector | zero-yield | 0 | yes | Zero-yield for 6 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 9 | monshaat-events | active-collector | productive | 3 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 12 | eye-of-riyadh-events | discovery-only | productive | 16 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 13 | ten-times-saudi | discovery-only | discovery-only | 0 | no | Use only as discovery evidence; never publish directly. |
| 14 | eventbrite-saudi | discovery-only | productive | 18 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 57 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 19 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | probe-blocked | 52 | no | Do not bypass protection; keep as blocked/partnership candidate: timeout |
...
| 37 | moc-cultural-subportals | active-collector | productive | 13 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 38 | historic-jeddah-albalad | extractor-backlog | not-attempted | 0 | no | Probe HTML/API shape, then decide whether an extractor is worth adding. |
...
| 41 | ricec-events | venue-dedupe | probe-blocked | 0 | no | Do not bypass protection; keep as blocked/partnership candidate: fetch failed Connect Timeout Error (attempted address: www.ricec.com:443, timeout: 10000ms) TypeError: fetch failed |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 51 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 56 | scega-exhibitions-conferences | extractor-backlog | productive | 4 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 60 | qassim-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 6 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 51 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 71 | najran-municipality-summer-events | venue-dedupe | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 74 | middle-east-banking-ai-summit | extractor-backlog | probe-blocked | 0 | no | Do not bypass protection; keep as blocked/partnership candidate: bot-protection |
| 75 | middle-east-enterprise-ai-summit | extractor-backlog | not-attempted | 0 | no | Probe HTML/API shape, then decide whether an extractor is worth adding. |
| 76 | money2020-middle-east-agendas | extractor-backlog | not-attempted | 0 | no | Latest deep probe recommends build-jsonld-event-extractor; build only if future date-complete rows are visible. |
| 77 | leap-official-agendas | extractor-backlog | not-attempted | 0 | no | Probe HTML/API shape, then decide whether an extractor is worth adding. |
