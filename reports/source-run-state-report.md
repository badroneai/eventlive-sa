...
Generated at: 2026-07-11T05:27:12.663Z
...
| mos-events | collector-error | 0 | raw_harvest_to_candidate_queue | Fix collector error: fetch failed; page.goto: Timeout 60000ms exceeded.
Call log:
...
| sdaia-academy-programs | collector-error | 0 | raw_harvest_to_candidate_queue | Fix collector error: fetch failed; page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at https://sdaia.gov.sa/en/Sectors/academy/bootcamps/Pages/default.aspx
Call log:
...
| sdaia-calendar-events | collector-error | 0 | raw_harvest_to_candidate_queue | Fix collector error: fetch failed; page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at https://sdaia.gov.sa/en/MediaCenter/Events/Pages/default.aspx
Call log:
...
| code-mcit-programs | zero-yield | 70 | raw_harvest_to_candidate_queue | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 70 | raw_harvest_to_candidate_queue | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 70 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | probe-blocked | 50 | no | Do not bypass protection; keep as blocked/partnership candidate: timeout |
...
| 54 | sdaia-calendar-events | active-collector | collector-error | 0 | no | Fix collector error: fetch failed; page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at https://sdaia.gov.sa/en/MediaCenter/Events/Pages/default.aspx
Call log:
  - navigating to "https://sdaia.gov.sa/en/MediaCenter/Events/Pages/default.aspx", waiting until "domcontentloaded"
 |
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 64 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 64 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 25 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 25 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | no rows detected by extractor |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 13 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
