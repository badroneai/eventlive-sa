...
Generated at: 2026-07-10T11:15:37.936Z
...
| code-mcit-programs | zero-yield | 60 | raw_harvest_to_candidate_queue | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 60 | raw_harvest_to_candidate_queue | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 60 | raw_harvest_to_candidate_queue | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 60 | raw_harvest_to_candidate_queue | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 54 | raw_harvest_to_candidate_queue | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 22 | raw_harvest_to_candidate_queue | Zero-yield for 22 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| northern-borders-chamber-events | zero-yield | 15 | probe_before_collector | Zero-yield for 15 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| tabuk-chamber-events | zero-yield | 15 | probe_before_collector | Zero-yield for 15 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| mos-events | zero-yield | 9 | raw_harvest_to_candidate_queue | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 4 | mos-events | active-collector | zero-yield | 0 | yes | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 60 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 22 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 54 | sdaia-calendar-events | active-collector | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 60 | qassim-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 54 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 15 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 15 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
