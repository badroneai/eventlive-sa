...
Generated at: 2026-07-10T04:25:24.507Z
...
| experience-alula-events | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 7 | experience-alula-events | active-collector | zero-yield | 0 | yes | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 51 | riyadh-city-events | extractor-backlog | probe-blocked | 40 | no | Do not bypass protection; keep as blocked/partnership candidate: fetch failed TypeError: fetch failed |
