...
Generated at: 2026-07-11T01:26:55.354Z
...
| code-mcit-programs | zero-yield | 69 | raw_harvest_to_candidate_queue | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 69 | raw_harvest_to_candidate_queue | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 69 | raw_harvest_to_candidate_queue | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 69 | raw_harvest_to_candidate_queue | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 63 | raw_harvest_to_candidate_queue | Zero-yield for 63 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 63 | raw_harvest_to_candidate_queue | Zero-yield for 63 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 31 | raw_harvest_to_candidate_queue | Zero-yield for 31 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| northern-borders-chamber-events | zero-yield | 24 | probe_before_collector | Zero-yield for 24 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| tabuk-chamber-events | zero-yield | 24 | probe_before_collector | Zero-yield for 24 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| madinah-chamber-events | zero-yield | 12 | raw_harvest_to_candidate_queue | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 4 | mos-events | active-collector | zero-yield | 0 | yes | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 69 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 31 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | productive | 50 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 51 | riyadh-city-events | extractor-backlog | probe-blocked | 93 | no | Do not bypass protection; keep as blocked/partnership candidate: fetch failed unable to verify the first certificate; if the root CA is installed locally, try running Node.js with --use-system-ca TypeError: fetch failed |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 63 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 60 | qassim-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 63 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 24 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 24 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 12 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
