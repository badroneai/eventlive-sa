...
Generated at: 2026-07-10T02:32:52.015Z
...
| experience-alula-events | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| code-mcit-programs | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| ithra-events | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 45 | raw_harvest_to_candidate_queue | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 39 | raw_harvest_to_candidate_queue | Zero-yield for 39 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 39 | raw_harvest_to_candidate_queue | Zero-yield for 39 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 7 | raw_harvest_to_candidate_queue | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| mos-events | zero-yield | 4 | raw_harvest_to_candidate_queue | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 4 | mos-events | active-collector | zero-yield | 0 | yes | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 7 | experience-alula-events | active-collector | zero-yield | 0 | yes | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | zero-yield | 0 | yes | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 25 | sdaia-academy-programs | active-collector | zero-yield | 0 | no | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 45 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 39 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 60 | qassim-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 39 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
