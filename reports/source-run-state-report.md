...
Generated at: 2026-09-03T04:45:40.767Z
...
| code-mcit-programs | zero-yield | 77 | raw_harvest_to_candidate_queue | Zero-yield for 77 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 77 | raw_harvest_to_candidate_queue | Zero-yield for 77 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 71 | raw_harvest_to_candidate_queue | Zero-yield for 71 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 71 | raw_harvest_to_candidate_queue | Zero-yield for 71 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 8 | mdlbeast-events | active-collector | productive | 6 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 9 | monshaat-events | active-collector | productive | 2 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 23 | ithra-events | active-collector | productive | 68 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | productive | 32 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 39 | discover-aseer-events | active-collector | zero-yield | 0 | yes | Zero-yield for 9 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 48 | sfda-events | active-collector | zero-yield | 0 | no | Zero-yield for 11 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 71 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
Call log:
  - navigating to "https://www.chamber.org.sa/sites/Arabic/Events/ChamberEvents/Pages/AllChamberEvents.aspx", waiting until "domcontentloaded"
 |
| 60 | qassim-chamber-events | active-collector | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 71 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 38 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 20 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 71 | najran-municipality-summer-events | venue-dedupe | zero-yield | 0 | no | Zero-yield for 18 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 88 | saudicon-events | discovery-only | productive | 4 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
