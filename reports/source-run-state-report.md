...
Generated at: 2026-07-10T06:58:44.535Z
...
| code-mcit-programs | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| ithra-events | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| misk-hub-events | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-pro-league-fixtures | zero-yield | 48 | raw_harvest_to_candidate_queue | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 42 | raw_harvest_to_candidate_queue | Zero-yield for 42 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| abha-chamber-events | zero-yield | 42 | raw_harvest_to_candidate_queue | Zero-yield for 42 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| saudi-space-agency-events | zero-yield | 10 | raw_harvest_to_candidate_queue | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| mos-events | zero-yield | 7 | raw_harvest_to_candidate_queue | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 4 | mos-events | active-collector | zero-yield | 0 | yes | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 14 | eventbrite-saudi | discovery-only | productive | 16 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | zero-yield | 0 | yes | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 25 | sdaia-academy-programs | active-collector | zero-yield | 0 | no | Zero-yield for 7 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 48 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 42 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 42 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 3 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 74 | qassim-university-events | venue-dedupe | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 75 | jouf-university-programs | venue-dedupe | productive | 1 | no | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
| 76 | money2020-middle-east-agendas | extractor-backlog | not-attempted | 0 | no | Probe HTML/API shape, then decide whether an extractor is worth adding. |
