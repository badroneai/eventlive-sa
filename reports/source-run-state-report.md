...
Generated at: 2026-07-28T16:00:48.333Z
...
- Deferred by adaptive cadence: 15
- Productive: 20
- Zero-yield: 3
- Collector errors: 7
...
| sdaia-calendar-events | collector-error | 0 | raw_harvest_to_candidate_queue | Fix collector error: request-rejected; browser recovery encountered an access-protection page |
...
| 54 | sdaia-calendar-events | active-collector | collector-error | 0 | no | Fix collector error: request-rejected; browser recovery encountered an access-protection page |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 5 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 10 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
