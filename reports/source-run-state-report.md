...
Generated at: 2026-09-23T08:03:55.242Z
...
| code-mcit-programs | zero-yield | 79 | raw_harvest_to_candidate_queue | Zero-yield for 79 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| jcci-events-center | zero-yield | 79 | raw_harvest_to_candidate_queue | Zero-yield for 79 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| makkah-chamber-events | zero-yield | 73 | raw_harvest_to_candidate_queue | Zero-yield for 73 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 7 | experience-alula-events | active-collector | productive | 6 | yes | Continue periodic collection; dedupe and auto-publish only through the candidate gate. |
...
| 25 | sdaia-academy-programs | active-collector | zero-yield | 0 | no | Zero-yield for 23 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 8 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | probe-blocked | 44 | no | Do not bypass protection; keep as blocked/partnership candidate: timeout |
...
| 39 | discover-aseer-events | active-collector | zero-yield | 0 | yes | Zero-yield for 13 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 44 | saudi-water-authority-events | active-collector | zero-yield | 0 | no | Zero-yield for 6 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 48 | sfda-events | active-collector | zero-yield | 0 | no | Zero-yield for 14 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 54 | sdaia-calendar-events | active-collector | zero-yield | 0 | no | Zero-yield for 4 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 65 | northern-borders-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 21 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 66 | tabuk-chamber-events | extractor-backlog | zero-yield | 0 | no | Zero-yield for 41 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 67 | jazan-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 23 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 71 | najran-municipality-summer-events | venue-dedupe | zero-yield | 0 | no | Zero-yield for 21 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 76 | umm-al-qura-events | active-collector | zero-yield | 0 | no | No future date-complete candidates found by the conservative extractor. |
...
| 81 | jouf-university-programs | venue-dedupe | zero-yield | 0 | no | Zero-yield for 8 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 83 | madinah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 29 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 87 | kau-events | venue-dedupe | zero-yield | 0 | no | Zero-yield for 15 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
