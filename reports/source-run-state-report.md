...
Generated at: 2026-07-09T11:59:57.583Z
...
| ricec-events | probe-blocked | 0 | dedupe_anchor_only | Do not bypass protection; keep as blocked/partnership candidate: fetch failed getaddrinfo ENOTFOUND www.ricec.com TypeError: fetch failed |
...
| 7 | experience-alula-events | active-collector | zero-yield | 0 | yes | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 20 | code-mcit-programs | active-collector | zero-yield | 0 | yes | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 23 | ithra-events | active-collector | zero-yield | 0 | yes | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 28 | misk-hub-events | active-collector | zero-yield | 0 | no | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 29 | jcci-events-center | active-collector | zero-yield | 0 | no | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
| 30 | saudi-pro-league-fixtures | active-collector | zero-yield | 0 | no | Zero-yield for 32 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 32 | saudi-space-agency-events | active-collector | zero-yield | 0 | no | Zero-yield for 17 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 41 | ricec-events | venue-dedupe | probe-blocked | 0 | no | Do not bypass protection; keep as blocked/partnership candidate: fetch failed getaddrinfo ENOTFOUND www.ricec.com TypeError: fetch failed |
...
| 55 | makkah-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 26 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 61 | abha-chamber-events | active-collector | zero-yield | 0 | no | Zero-yield for 26 runs; inspect dropped samples or reclassify cadence if the source is seasonal/archive-only. |
...
| 66 | tabuk-chamber-events | extractor-backlog | not-attempted | 0 | no | Probe HTML/API shape, then decide whether an extractor is worth adding. |
