...
- generated_at: 2026-08-21T02:18:29.541Z
...
- Sources due now: 31
- Sources attempted in latest collection: 31
- Sources deferred by cadence: 17
- Due-source coverage: 100%
- Scheduled runnable coverage: 100%
- Whole-registry attempted this run: 35%
- Healthy sources: 19
...
| 9 | Monsha'at All Events | collection-error | 0 | 1 | fetch failed; fetch failed |
...
| 12 | Eye of Riyadh Events | collection-error | 0 | 5 | Discovery-only source unavailable in this run: HTTP 403 |
...
| 88 | Saudicon Events | healthy | 13 | 13 | استمر بالمراجعة والتكرار قبل النشر. |
