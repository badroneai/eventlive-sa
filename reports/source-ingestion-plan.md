...
Generated at: 2026-08-13T19:57:05.220Z
...
| discover-aseer-events | ok | 36 | - | Run in the 6-hour sync ring; keep dedupe and image enrichment active. |
...
| umm-al-qura-events | ok | 8 | - | Run in the 6-hour sync ring; keep dedupe and image enrichment active. |
...
| 75 | middle-east-enterprise-ai-summit | extractor-backlog | twice-weekly-extractor-probe | 22 | blocked-or-protected:fetch failed TypeError: fetch failed | Do not scrape now; latest probe is blocked-or-protected:fetch failed TypeError: fetch failed. Keep as partnership, browser/API investigation, or evidence lane. |
