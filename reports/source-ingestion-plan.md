...
Generated at: 2026-07-10T04:25:24.362Z
...
| 4 | riyadh-city-events | extractor-backlog | twice-weekly-extractor-probe | blocked-or-protected:fetch failed TypeError: fetch failed | Do not scrape now; latest probe is blocked-or-protected:fetch failed TypeError: fetch failed. Keep as partnership, browser/API investigation, or evidence lane. |
...
| 11 | najran-municipality-summer-events | venue-dedupe | weekly-dedupe-check | - | Use as a discovery anchor, then reconcile against organizer, ticketing, and catalog duplicates. |
| 12 | baha-amanah-events | extractor-backlog | twice-weekly-extractor-probe | blocked-or-protected:bot-protection | Do not scrape now; latest probe is blocked-or-protected:bot-protection. Keep as partnership, browser/API investigation, or evidence lane. |
