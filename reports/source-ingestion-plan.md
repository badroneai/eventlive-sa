...
Generated at: 2026-07-15T19:44:37.929Z
...
| 5 | visit-saudi-calendar-pdf | venue-dedupe | weekly-dedupe-check | watch-or-evidence-only | Use as a discovery anchor, then reconcile against organizer, ticketing, and catalog duplicates. |
...
|---|---|---:|---|---|
| visit-saudi-calendar | ok | 5 | - | Run in the 6-hour sync ring; keep dedupe and image enrichment active. |
...
| visit-saudi-seasons | error | 0 | - | Run in the 6-hour sync ring; improve zero-yield extractors before widening. |
...
| 34 | visit-saudi-calendar-pdf | venue-dedupe | weekly-dedupe-check | 82 | watch-or-evidence-only | Use as a discovery anchor, then reconcile against organizer, ticketing, and catalog duplicates. |
